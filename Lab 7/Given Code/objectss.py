...
class Point:
    ...
    def distance(self, other):
        dist = math.sqrt((other.x_cord - self.x_cord) ** 2 + (other.y_cord - self.y_cord) ** 2)
        return dist
...
class Circle:
    ...
    # Purpose- this value gets the new value and makes sure it doesn't equal the old one
    ...
    def __it__(self):
        return 'Circle( ' + 'r' + str(self.radius) + '@' + str(self.center.x_cord) + ', ' + str(self.center.y_cord) + ')'


    def __repr__(self):
        return 'Circle( ' + 'r' + str(self.radius) + '@' + str(self.center.x_cord) + ', ' + str(
            self.center.y_cord) + ')'
