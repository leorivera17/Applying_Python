...
#    board = ('', main_list[0], ' | ', main_list[1], ' | ', main_list[2],
#             '-------------',
...
def check_rows(main_list):
    ...
    if 'X' == main_list[1] and 'X' == main_list[2] and 'X' == main_list[3]:
        print('WINNER')
    if 'X' == main_list[4] == main_list[5] == main_list[6]:
        print('WINNER')
    if 'X' == main_list[7] == main_list[8] == main_list[9]:
        print('WINNER')
    if 'O' == main_list[1] == main_list[2] == main_list[3]:
        print('WINNER')
    if 'O' == main_list[4] == main_list[5] == main_list[6]:
        print('WINNER')
    if 'O' == main_list[7] == main_list[8] == main_list[9]:
        print('WINNER')
...
def check_diags(main_list):
    if 'X' or 'O' == main_list[1] and main_list[5] and main_list[9]:
        return 'win'
    if main_list['7'] == main_list['5'] == main_list['3'] != ' ':
        print('WINNER')
...
def check_win(main_list):
    if check_rows(main_list):
        return 'WIN'
    if check_cols(main_list):
        return 'WIN'
    if check_diags(main_list):
        return 'WIN'
    else:
        return 'NO WINNER'
